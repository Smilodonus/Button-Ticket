...
.setLabel("")
                    ...
                    let row = new MessageActionRow()
                        ...
                        .addComponent(btn4)
                        .addComponent(btn5)
                    channel.send(`<@${button.clicker.user.id}> <a:arrow:883915864980746270> <@&${adminRole}>`, {
                        embed: {
                            description: `Please wait for an Admin to respond!!\n\n__**Please Tell Us What You Need Help On!**__\n\n**<a:yes:883527265311416341>Ticket Category: Other**\n
                    Press **🔒** to close this ticket`,
                            color: 0x2F3136
                        },
                        component: row
...
.setLabel("")
                    ...
                    channel.send(`<@${button.clicker.user.id}> <a:arrow:883915864980746270> <@&${adminRole}> `, {
                        embed: {
                            description: `Please wait for an Admin to respond!!\n\n__**Please Tell Us What You Need Help On!**__\n\n**<:reply:921666636904280074>Ticket Category: Claim**\n
                    Press **🔒** to close this ticket`,
                            color: 0x2F3136
                        },
      ...
      .setEmoji('887650847327158343')
                ...
                button.message.edit({
                    embed: {
                        description: `Please wait for an Admin to respond!!\n\n__**Please Tell Us What You Need Help On!**__\n\n**${client.emoji.reply}Ticket Category: Other**\nEdited by: __**${button.clicker.user.tag}**__\n
                    Press **🔒** to close this ticket`,
                        color: 0x2F3136
                    }
                })
